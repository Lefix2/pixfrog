...
int main(int argc, char** argv) {
    ...
    std::fprintf(o,
                 ...
                 "// 8-bit coverage, row-major, %dx%d + %dx%d cells, ASCII 0x%02X..0x%02X.\n"
                 "// Regenerate: see tools/fontgen/README.md\n\n"
                 "#include \"font.h\"\n\n"
                 "namespace pixfrog::ui::detail {\n\n"
                 "// clang-format off\n",
                 ttf_path, px, baseline, xpad, gain, px_l, baseline_l, gain_l, kSmall.cell_w,
                 kSmall.cell_h, kLarge.cell_w, kLarge.cell_h, kFirst, kLast);
