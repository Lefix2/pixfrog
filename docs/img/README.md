...
|------------------------------|------------------------------------------------------------------------------------------------------|----------------|---------|
| `board-hero.jpg`             | Photo of the ESP32-P4 dev board running pixfrog, OLED showing the home screen, a LED strip lit       | 1600×900       | Landing page hero (auto) |
...
| `nrz-encoding.png`           | 1-wire NRZ waveform: how a `0` and a `1` bit map to samples (`samples_per_bit`)                       | 1200×500       | PROTOCOLS §4.1 |
| `clocked-encoding.png`       | SPI-like clocked encoding (APA102/SK9822): DATA aligned to CLOCK edges                                | 1200×500       | PROTOCOLS §4.2 |
| `logo.svg`                   | A real frog mark to replace the 🐸 emoji in the nav/footer/favicon (optional)                        | square         | Site (optional) |
