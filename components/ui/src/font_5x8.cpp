// Public-domain 5×7 ASCII bitmap font (column-major).
//
// Layout per glyph: 5 bytes, each byte = one column of 8 vertical pixels.
// Bit 0 = top pixel of the column, bit 7 = bottom. Rows 0..6 are used,
// row 7 is normally blank for inter-line spacing.
//
// Same byte values as the well-known "GLCD font" / Adafruit GFX 5×7 font.
